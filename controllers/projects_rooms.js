...
(function() {
  ...
  module.exports = function(app, model, Placeable, Layout) {
    var resource;
    resource = Resource(app, '/projects/:projectId', 'Rooms', model).rest({
      ...
      after: function(req, res, next) {
        return Nested.find('room', Layout, 'layouts', req.method, res.resource.item, function(error, result) {
          return Nested.find('room', Placeable, 'placeables', req.method, res.resource.item, function(error, result) {
            return next();
          });
        });
      }
...
//# sourceMappingURL=projects_rooms.js.map
